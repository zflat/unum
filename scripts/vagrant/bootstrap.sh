...
# Pre-installation
echo "Bootstrap: setting common environment in /etc/profile.d/vagrant-app-env.sh"
sudo sh -c "cat /vagrant/scripts/vagrant/common.env > /etc/profile.d/vagrant-app-env.sh"
